...
$answers = get_field('answers', $current_voting);
...
<div class="content">
    <h3><?php the_field('question', $current_voting); ?></h3>


    <?php if (!$showVotingResults) { ?>
        <?php foreach ($answers as $answer) { ?>
            <a href="#"
               class="<?php if ($votingNotStarted || $votingIsFinished) { ?>disabled<?php } ?> poll-answer vote-btn"
